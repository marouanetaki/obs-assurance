    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.medicaments.update", [$medicament->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $medicament->code) }}" required>
                @if($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom" id="nom" value="{{ old('nom', $medicament->nom) }}" required>
                @if($errors->has('nom'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nom') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('presentation') ? 'is-invalid' : '' }}" name="presentation" id="presentation">{{ old('presentation', $medicament->presentation) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prix') ? 'is-invalid' : '' }}" type="number" name="prix" id="prix" value="{{ old('prix', $medicament->prix) }}" step="0.01">
                @if($errors->has('prix'))
                    <div class="invalid-feedback">
                        {{ $errors->first('prix') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taux') ? 'is-invalid' : '' }}" type="number" name="taux" id="taux" value="{{ old('taux', $medicament->taux) }}" step="1" required>
                @if($errors->has('taux'))
                    <div class="invalid-feedback">
                        {{ $errors->first('taux') }}
                    </div>
